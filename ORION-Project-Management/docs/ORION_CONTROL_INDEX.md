...
النطاق:
المراحل الرسمية الحالية وترتيب التطوير وشروط الانتقال.
...
النطاق:
الأهداف والمراحل الكبرى المستقبلية بعد استقرار الأساس الحالي.

تقرأ عند:
- مراجعة الاتجاه طويل الأجل.
- التحقق من عدم ضياع الأهداف النهائية.
- مراجعة تأثير تطوير حالي على المراحل المستقبلية.
- التخطيط للانتقال من Core إلى Scalping ثم GUI وExplosion Radar وTrading Bot.

هذه الوثيقة تخطيطية فقط ولا تغيّر المرحلة الحالية ولا تعطي المطور أوامر تنفيذ مستقبلية مبكرة.
...
→ DECISIONS
→ ROADMAP
→ FUTURE ROADMAP عند وجود تأثير طويل الأجل
→ الملفات المرتبطة
...
→ ARCHITECTURE
→ ARCHITECTURE FINDINGS
→ FUTURE ROADMAP إذا كان للتطوير أثر مستقبلي
→ الملفات التي تغيرت
→ الاختبارات
→ الوثائق المرتبطة عند الحاجة
...
الأهداف والمراحل المستقبلية الكبرى:
FUTURE ROADMAP
...
الأهداف المستقبلية الكبرى تكون في ORION_FUTURE_ROADMAP.md، بينما المرحلة الحالية والخطوة التالية تبقيان في ORION_PROJECT_STATE.md وORION_ROADMAP.md.
