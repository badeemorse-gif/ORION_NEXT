...
==================================================
14. المزامنة (تحديث فوري أول بأول)
==================================================
...
القاعدة الصارمة المحدثة:
تتم المزامنة فوراً أول بأول لأي إجراء أو تعديل يتم تنفيذه في المشروع، ولو كان بسيطاً أو صغيراً.
يُمنع منعاً باتاً تأجيل المزامنة أو انتظار اكتمال مجموعة تعديلات لإجراء المزامنة.

التسلسل المعتمد لكل تعديل:

1. تعديل الملفات محليًا.
2. حفظ الملفات.
3. اختبار التعديلات.
4. اعتماد التعديل.
5. تشغيل ORION Sync فوراً.
6. Commit.
7. Push.
8. التحقق من GitHub.
...
# ORION — GPT Execution Rules (English Reference Sections)
...
## 1. Purpose & Core Rules Summary
The operational rules enforce strict adherence to the local implementation baseline, target architecture, and mandatory execution order.

## 2. Mandatory Document Order
1. `ORION_GPT_EXECUTION_RULES.md`
2. `ORION_CONTROL_INDEX.md`
3. `ORION_PROJECT_STATE.md`
4. Target Architecture & Baseline documents.
