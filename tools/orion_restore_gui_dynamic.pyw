...
def refresh(self):
 ...
 def w():
  try:bs=discover(self);self.branches=bs;self.root.after(0,self.branch_combo.configure,values=(ALL,*bs));self.root.after(0,self._status,"جاهز للاستعادة",self.success)
