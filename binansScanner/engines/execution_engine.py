...
class ExecutionSide(str, Enum):
    """Enumeration of permitted order execution sides."""
    BUY = "BUY"
    SELL = "SELL"
    HOLD = "HOLD"
    NONE = "NONE"
...
class ExecutionStatus(str, Enum):
    """Enumeration tracking the status lifecycle of an execution request."""
    PENDING = "PENDING"
    VALIDATED = "VALIDATED"
    EXECUTED = "EXECUTED"
    SKIPPED = "SKIPPED"
...
class ExecutionRequest:
    """Immutable data structure representing a structured trading order request."""
    symbol: str
...
class ExecutionResult:
    """Immutable container capturing execution outcomes, metadata, and order metrics."""
...
class ExecutionEngine:
    ...
    def _log_execution(self, result: ExecutionResult) -> None:
        ...
        dec = req.decision.value if req and isinstance(req.decision, ExecutionSide) else "N/A"
