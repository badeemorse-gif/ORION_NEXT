...
class TradingReadiness:
    ...
    def __post_init__(self) -> None:
        for name in ("intelligence_complete", "confidence_acceptable", "opportunity_fresh", "risk_acceptable", "market_conditions_valid"):
    ...
    def eligible(self) -> bool:
        return all((self.intelligence_complete, self.confidence_acceptable, self.opportunity_fresh, self.risk_acceptable, self.market_conditions_valid))
